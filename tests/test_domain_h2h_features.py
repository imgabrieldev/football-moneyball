"""Tests for football_moneyball.domain.h2h_features."""
...
class TestComputeH2HFeatures:
    ...
    def test_ignores_irrelevant_matches(self):
        history = [
            ...
            {"home_team": "C", "away_team": "D", "home_goals": 1, "away_goals": 1},  # irrelevant
        ]
        f = compute_h2h_features(history, "A", "B")
